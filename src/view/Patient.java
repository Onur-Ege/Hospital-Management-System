...
public class Patient extends javax.swing.JFrame {
    ...
    private String generatePatientId() throws ClassNotFoundException, SQLException{
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "First Name", "Last Name", "E-mail", "Gender"
            }
        ) {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            ...
            PreparedStatement pst = conn.prepareStatement("insert into patient(id,firstname,lastname,email,gender) values(?,?,?,?,?)");
